...
export const onboardingProfiles = sqliteTable("onboarding_profiles", {
  ...
  organizationEmployeeCount: integer("organization_employee_count"),
  organizationAssetSize: text("organization_asset_size").notNull().default(""),
  directReports: integer("direct_reports"),
  reportsTo: text("reports_to").notNull().default(""),
  reportingStructure: text("reporting_structure").notNull().default(""),
  responsibilitiesJson: text("responsibilities_json").notNull().default("[]"),
  systemsJson: text("systems_json").notNull().default("[]"),
  communicationChannelsJson: text("communication_channels_json").notNull().default("[]"),
